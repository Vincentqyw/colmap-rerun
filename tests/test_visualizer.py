...
from colmap_rerun.core.reconstruction import ReconstructionData
from colmap_rerun.visualization.visualizer import (
    convert_simple_radial_to_pinhole,
    scale_camera
)

def test_convert_simple_radial_to_pinhole():
    """Test camera model conversion."""
    from colmap_rerun.core.model import Camera
    camera = Camera(
        id=1,
        model="SIMPLE_RADIAL",
        width=640,
